    ...
    if (method === 'tools/list') {
      return res.json({
        ...
        result: {
          tools: [
            // SOFTBALL
            { name: 'get_softball_scores', description: 'Get softball scores for a specific date' },
            { name: 'get_softball_schedule', description: 'Get softball schedule for a specific month' },
            ...
            // WOMEN'S BASKETBALL
            { name: 'get_womens_basketball_scores', description: 'Get women\'s basketball scores' },
            { name: 'get_womens_basketball_schedule', description: 'Get women\'s basketball schedule' },
            { name: 'get_womens_basketball_rankings', description: 'Get women\'s basketball rankings' },
            { name: 'get_womens_basketball_stats', description: 'Get women\'s basketball stats' },
            { name: 'get_womens_basketball_standings', description: 'Get women\'s basketball standings' },
            // VOLLEYBALL
            { name: 'get_volleyball_scores', description: 'Get volleyball scores' },
            { name: 'get_volleyball_schedule', description: 'Get volleyball schedule' },
            { name: 'get_volleyball_rankings', description: 'Get volleyball rankings' },
            { name: 'get_volleyball_stats', description: 'Get volleyball stats' },
            { name: 'get_volleyball_standings', description: 'Get volleyball standings' },
            // SOCCER
            { name: 'get_soccer_scores', description: 'Get soccer scores' },
            { name: 'get_soccer_schedule', description: 'Get soccer schedule' },
            { name: 'get_soccer_rankings', description: 'Get soccer rankings' },
            { name: 'get_soccer_stats', description: 'Get soccer stats' },
      ...
      if (name === 'get_softball_scores') {
        ...
        try {
          ...
          if (!response.ok) {
            return res.json({
              jsonrpc: '2.0',
              result: { content: [{ type: 'text', text: `NCAA API error: ${response.status}` }] },
              id
            });
          }
